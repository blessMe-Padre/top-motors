...
/* harmony import */ var _modules_sticky_header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/sticky-header */ "./js/modules/sticky-header.js");
/* harmony import */ var _modules_scroll_to_top__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/scroll-to-top */ "./js/modules/scroll-to-top.js");
...
/* harmony import */ var _modules_exclusive_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/exclusive-slider */ "./js/modules/exclusive-slider.js");
/* harmony import */ var _modules_mixitup__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/mixitup */ "./js/modules/mixitup.js");
/* harmony import */ var _modules_mixitup__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_mixitup__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _modules_wow__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/wow */ "./js/modules/wow.js");
/* harmony import */ var _modules_wow__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_modules_wow__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _modules_tabs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/tabs */ "./js/modules/tabs.js");
/* harmony import */ var _modules_steps__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/steps */ "./js/modules/steps.js");
/* harmony import */ var _modules_popup__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/popup */ "./js/modules/popup.js");
/* harmony import */ var _modules_in_stock_slider__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/in-stock-slider */ "./js/modules/in-stock-slider.js");
/* harmony import */ var _modules_in_stock_slider_reverse__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/in-stock-slider-reverse */ "./js/modules/in-stock-slider-reverse.js");
/* harmony import */ var _modules_mask__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/mask */ "./js/modules/mask.js");
/* harmony import */ var _modules_validation__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/validation */ "./js/modules/validation.js");
/* harmony import */ var _modules_decoration_element__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/decoration-element */ "./js/modules/decoration-element.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // Modules
  Object(_modules_sticky_header__WEBPACK_IMPORTED_MODULE_1__["initStickyHeader"])();
  Object(_modules_nav__WEBPACK_IMPORTED_MODULE_0__["initNav"])();
  Object(_modules_scroll_to_top__WEBPACK_IMPORTED_MODULE_2__["initScrollToTop"])();
  ...
  Object(_modules_exclusive_slider__WEBPACK_IMPORTED_MODULE_5__["initExclusiveSlider"])();
  Object(_modules_in_stock_slider__WEBPACK_IMPORTED_MODULE_11__["initInStockSlider"])();
  Object(_modules_in_stock_slider_reverse__WEBPACK_IMPORTED_MODULE_12__["initInStockSliderReverse"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_8__["initTabs"])();
  Object(_modules_steps__WEBPACK_IMPORTED_MODULE_9__["initSteps"])();
  Object(_modules_popup__WEBPACK_IMPORTED_MODULE_10__["initPopup"])();
  Object(_modules_validation__WEBPACK_IMPORTED_MODULE_14__["initValidation"])();
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_13__["initMask"])();
  Object(_modules_decoration_element__WEBPACK_IMPORTED_MODULE_15__["initDecoration"])();
  new _modules_wow__WEBPACK_IMPORTED_MODULE_7___default.a().init();
});

/***/ }),

/***/ "./js/modules/decoration-element.js":
/*!******************************************!*\
  !*** ./js/modules/decoration-element.js ***!
  \******************************************/
/*! exports provided: initDecoration */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initDecoration", function() { return initDecoration; });
var initDecoration = function initDecoration() {
  // Получаем все элементы с классом 'decor-section' на странице
  var decorSections = document.querySelectorAll('.decor-section');
  function updateLineWidth() {
    // Итерация по каждому элементу decorSection
    decorSections.forEach(function (decorSection) {
      // Для текущего элемента decorSection, получаем соответствующий элемент с классом 'decor-section-line'
      var line = decorSection.querySelector('.decor-section-line');

      // Получаем позиционные параметры элемента decorSection
      var rect = decorSection.getBoundingClientRect();
      ...
      var totalPotentialScroll = window.innerHeight - 200 - rect.height;

      // Вычисляем прокрученное расстояние от нижней границы элемента до нижней границы видимой области окна
      var scrolledDistance = window.innerHeight - rect.bottom;

      // Вычисляем процент прокрутки
      var scrolledPercentage = scrolledDistance / totalPotentialScroll;
...
/***/ "./js/modules/exclusive-slider.js":
/*!****************************************!*\
  !*** ./js/modules/exclusive-slider.js ***!
  \****************************************/
/*! exports provided: initExclusiveSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initExclusiveSlider", function() { return initExclusiveSlider; });
var initExclusiveSlider = function initExclusiveSlider() {
  var exclusiveSlider = document.querySelector('.exclusive__slider');
  if (exclusiveSlider) {
    ...
    var exclusiveSliderInit = function exclusiveSliderInit() {
...
/***/ "./js/modules/in-stock-slider-reverse.js":
/*!***********************************************!*\
  !*** ./js/modules/in-stock-slider-reverse.js ***!
  \***********************************************/
/*! exports provided: initInStockSliderReverse */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initInStockSliderReverse", function() { return initInStockSliderReverse; });
var initInStockSliderReverse = function initInStockSliderReverse() {
  var inStockSliderReverse = document.querySelector('.in-stock__slider-reverse');
    ...
    new Swiper(inStockSliderReverse, {
      ...
      pagination: {
        ...
        renderBullet: function renderBullet(index, className) {
          var bulletTexts = ['Mercedes', 'BMW', 'Audi', 'Hyundai', 'KIA', 'Ssangyong'];
...
/***/ "./js/modules/in-stock-slider.js":
/*!***************************************!*\
  !*** ./js/modules/in-stock-slider.js ***!
  \***************************************/
/*! exports provided: initInStockSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initInStockSlider", function() { return initInStockSlider; });
var initInStockSlider = function initInStockSlider() {
  var inStockSlider = document.querySelector('.in-stock__slider');
  if (inStockSlider) {
    new Swiper(inStockSlider, {
      ...
      pagination: {
        ...
        clickable: true,
        renderBullet: function renderBullet(index, className) {
          var bulletTexts = ['Toyota', 'Lexus', 'Nissan', 'Mazda', 'Honda', 'Subaru'];
          return '<span class="' + className + '">' + bulletTexts[index] + '</span>';
        }
      }
    });
...
(function (window) {
  ...
  var mixitUp = document.querySelector('.container-filter');
  if (mixitUp) {
    var mixer = _mixitup('.container-filter');
  }
})(window);
...
var initNav = function initNav() {
  ...
  button.addEventListener('click', function (evt) {
    ...
    var buttonAtrAttribute = button.getAttribute('aria-expanded') === true;
    buttonAtrAttribute ? button.setAttribute("aria-expanded", false) : button.setAttribute("aria-expanded", true);
  });
...
var initScroll = function initScroll() {
  ...
  var onMenuLinkClick = function onMenuLinkClick(evt) {
...
var initSteps = function initSteps() {
  var stepSection = document.querySelector('.steps');
  if (stepSection) {
    var getSteps = function getSteps() {
      var stepNumbers = document.querySelectorAll('.step__number');
      var progressSuccess = document.querySelector('.steps__progress-success');
      var stepItems = document.querySelectorAll('.steps__item');
      var prevButton = document.querySelector('.step__button--prev');
      var nextButton = document.querySelector('.step__button--next');
      var step = 0;
      ...
      function updateSteps() {
        ...
        var stepNumberActives = document.querySelectorAll('.step__number--active');
        var percent = (stepNumberActives.length - 1) / (stepNumbers.length - 1) * 100 + '%';
...
var initTabs = function initTabs() {
  ...
  var _loop = function _loop(index) {
    var tabs_item = tabs_items[index];
    ...
    tabs_item.addEventListener("click", function (e) {
      ...
      for (var _index = 0; _index < tabs_items.length; _index++) {
        var _tabs_item = tabs_items[_index];
        _tabs_item.classList.remove('_active');
        tabs_blocks[_index].classList.remove('_active');
        tabs_blocks[_index].style.maxHeight = null;
      }
  ...
  for (var index = 0; index < tabs_items.length; index++) {
    _loop(index);
  }

  // Добавляет класс .is-active к кнопке выбранного фильтра

  var orderButtons = document.querySelectorAll('.order__btn-1');
  if (orderButtons) {
...
var initValidation = function initValidation() {
  ...
  forms.forEach(function (form) {
    ...
    function formValidate(form) {
      ...
      var _iterator = _createForOfIteratorHelper(formReq),
        _step;
      try {
